...
local Window = OrionLib:MakeWindow({Name = "小本脚本", HidePremium = false, SaveConfig = false, IntroText = "欢迎使用", ConfigFolder = "欢迎使用"})
...
Tab:AddParagraph("作者","小本皮")
Tab:AddLabel("作者QQ：3578799539")
Tab:AddLabel("QQ群:无")
