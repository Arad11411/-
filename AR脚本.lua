...
Home:AddParagraph('AR制作','官方QQ3578799539')
Home:AddDropdown({
    Name = '脚本',
    Default = '',
...
game:GetService('Workspace').BlackMarket.BlackMarketBillboard.TopLabel.Text = 'AR黑市'
game:GetService('Workspace').BlackMarket.BlackMarketBillboard.BottomLabel.Text = '向YF出售物品以获得钱!'
game:GetService('Workspace').OhioSign.Screen.SurfaceGui.Frame.Population.Text = 'AR祝您玩的愉快'
