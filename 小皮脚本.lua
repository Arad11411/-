local function LoadXT_Script()
    ...
    local success, err = pcall(function()
        -- 使用原始GitHub链接加载脚本
        local scriptUrl = "https://raw.githubusercontent.com/XTxt-design/XT-/refs/heads/mai"
...
game:GetService("StarterGui"):SetCore("SendNotification",{ Title = "小皮脚本"; Text ="载入中"; Duration = 2; })wait("3")

game:GetService("StarterGui"):SetCore("SendNotification",{ Title = "小皮脚本"; Text ="小本皮牛比"; Duration = 2; })wait("3")

game:GetService("StarterGui"):SetCore("SendNotification",{ Title = "快来加入我们吧"; Text ="光用有什么用加入我们吧"; Duration = 2; })wait("3")

game:GetService("StarterGui"):SetCore("SendNotification",{ Title = "小皮脚本"; Text ="正在持续更新中"; Duration = 2; })

game:GetService("StarterGui"):SetCore("SendNotification",{ Title = "小皮脚本"; Text ="载入成功"; Duration = 2; })
...
local Window = OrionLib:MakeWindow({Name = "小皮脚本", HidePremium = false, SaveConfig = true,IntroText = "小皮脚本", ConfigFolder = "小皮脚本"})

game:GetService("StarterGui"):SetCore("SendNotification",{ Title = "小皮脚本"; Text ="欢迎使用小皮脚本"; Duration = 4; })
...
about:AddParagraph("作者: 小本皮")
about:AddParagraph("作者qq:3578799539")
about:AddParagraph("qq群: 无")
...
about:AddParagraph("此脚本免费")
about:AddParagraph("严禁倒卖")

local Tab =Window:MakeTab({
	Name = "复制作者信息",
	Icon = "rbxassetid://3578799539",
	PremiumOnly = false
})
Tab:AddButton({
	Name = "复制作者QQ",
	Callback = function()
     setclipboard("3578799539")
  	end
})
Tab:AddButton({
	Name = "复制QQ群",
...
Tab:AddButton({
    Name = "冷寂脚本（卡密：KL牛逼冷寂牛逼）",
    Callback = function()
        OrionLib:MakeNotification({Name = "提示", Content = "正在加载...", Time = 3})
        task.spawn(function()
            local success, err = pcall(function()
               loadstring(game:HttpGet("https://raw.githubusercontent.com/xmtdnmsl/toukanwodekuderenquanjiasiguang/refs/heads/main/LENGJINB.lua"))()
            end)
            if success then
                OrionLib:MakeNotification({Name = "成功", Content = "加载完成", Time = 3})
            else
...
Tab:AddButton({
    ...
    Callback = function()
        ...
        task.spawn(function()
        local success, err = pcall(function()
            loadstring(game:HttpGet("https://raw.githubusercontent.com/XTxt-design/XT-/refs/heads/main/%E6%B5%8B%E8%AF%95"))()  
            end)
            if success then
                OrionLib:MakeNotification({Name = "成功", Content = "加载完成", Time = 3})
            else
...
Tab:AddButton({
    ...
    Callback = function()
        ...
        task.spawn(function()
             local success, err = pcall(function()
              loadstring(game:HttpGet("https://raw.githubusercontent.com/nainshu/no/main/bypassDOORScheat.lua"))()  
            end)
            if success then
                OrionLib:MakeNotification({Name = "成功", Content = "加载完成", Time = 3})
            else
...
Tab:AddButton({
    ...
    Callback = function()
        ...
        task.spawn(function()
        local success, err = pcall(function()
              loadstring(game:HttpGet("https://raw.githubusercontent.com/XTxt-design/XT-/refs/heads/main/%E8%9C%82%E7%BE%A4%E8%84%9A%E6%9C%AC%E6%B1%89%E5%8C%96.txt"))()
            end)
            if success then
                OrionLib:MakeNotification({Name = "成功", Content = "加载完成", Time = 3})
            else
