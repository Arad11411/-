-[[
记住 十一只有被开源才能成长
by 皮脚本 冷脚本 刺猬集团 JM 无名 鹤脚本 云脚本 名脚本 鬼脚本
--]]
local OrionLib = loadstring(game:HttpGet("https://raw.githubusercontent.com/shlexw/Orion/main/sorce"))()
local Window = OrionLib:MakeWindow({Name = "十一脚本", HidePremium = false, IntroText = "十一脚本"})
...
Tab:AddParagraph("免费十一脚本（群:1047268678 快手:Arad）")

Tab:AddParagraph("持续云更新，如果发现不可用脚本请向作者反馈，加群加速更新")

Tab:AddParagraph("更新时间:7月17日，更新内容：啥也没有")
